...
class SMSMessage extends Request
{
	...
	public function __construct($strUsername = null, $strPassword = null, $arrOptions = [])
	{
	...
	protected function validate()
	{
		...
		if (is_null($this->shortcode)) {
			$this->objLogger->addDebug('Automatically removing shortcode since none was provided.');
